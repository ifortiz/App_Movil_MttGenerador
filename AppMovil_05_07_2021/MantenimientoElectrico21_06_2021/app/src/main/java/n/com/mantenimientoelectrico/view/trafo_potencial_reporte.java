...
public class trafo_potencial_reporte extends Fragment  implements  SupervisorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.trafo_potencial_reporte, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_atras.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.trafo_potencial_act_12));
