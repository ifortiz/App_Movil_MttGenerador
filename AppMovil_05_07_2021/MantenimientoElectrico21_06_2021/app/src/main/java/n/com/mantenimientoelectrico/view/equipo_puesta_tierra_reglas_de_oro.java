...
public class equipo_puesta_tierra_reglas_de_oro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.equipo_puesta_tierra_reglas_de_oro, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

        Button btn_SiguientePuestaTierraReglasOro = view.findViewById(R.id.btn_SiguientePuestaTierraReglasOro);
        Button btn_atrasReglasOro = view.findViewById(R.id.btn_AtrasPuestaTierraReglasOro);
        ...
        btn_SiguientePuestaTierraReglasOro.setOnClickListener(v -> validar());
        btn_atrasReglasOro.setOnClickListener(v ->  Navigation.findNavController(v).navigate(R.id.equipo_puesta_tierra_menu));
    }
    private  void validar(){
        ...
        if(errors.size()>=1){
            ...
            Navigation.findNavController(requireView()).navigate(R.id.equipo_puesta_tierra_equipos);
        }
    }
}