...
public class tab_control_termico_reporte extends Fragment   implements SupervisorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.tab_control_termico_reporte, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_atrasReporte.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.tab_control_termico_act_13));
        ...
        simpleResponseModel.getSimpleResponseObserve().observe(getViewLifecycleOwner(),s -> {
            if( s!=null){
                ...
                Navigation.findNavController(requireView()).navigate(R.id.menuSistemaReporteFragment);
            }else
