...
public class trafo_potencial_act_5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.trafo_potencial_act_5, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_atras1.setOnClickListener(v ->   Navigation.findNavController(v).navigate(R.id.trafo_potencial_act_4));
        ...
        actividadModel.getActividadObser().observe(getViewLifecycleOwner(), actividad -> {
            if ( actividad != null ){
                ...
                Navigation.findNavController(requireView()).navigate(R.id.trafo_potencial_act_6);
            }
        });
    }
