...
public class trafo_distribucion_reporte extends Fragment implements SupervisorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.trafo_distribucion_reporte, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

        Button btn_finalizar = view.findViewById(R.id.btn_finalizar_anillos_rozantes);
        Button btn_atrasReporte=view.findViewById(R.id.btn_atrasReporte);
        Button btn_guardar=view.findViewById(R.id.btn_Guardar_reporte_anillos);
        ...
        btn_atrasReporte.setOnClickListener(v ->  Navigation.findNavController(v).navigate(R.id.trafo_distribucion_act_12));
