...
public class trafo_distribucion_exci_ingresar_datos extends Fragment  implements  SpinnersActions{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.trafo_distribucion_exci_ingresar_datos, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_atras.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.trafo_auxiliares_equipos));
        ...
        simpleResponseModel.getSimpleResponseObserve().observe(getViewLifecycleOwner(), response -> {
            if ( response != null){
                ...
                navigate(R.id.trafo_distribucion_exci_act_1);
            }else
