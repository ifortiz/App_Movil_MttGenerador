...
public class tab_control_termico_ingresar_datos extends Fragment    implements SpinnersActions{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.tab_control_termico_ingresar_datos, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        simpleResponseModel.getSimpleResponseObserve().observe(getViewLifecycleOwner(), response -> {
            if ( response != null){
                ...
                navigate(R.id.tab_control_termico_act_1);
            }else
