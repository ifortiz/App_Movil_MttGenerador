...
public class sis_agua_enfriamiento_reglas_de_oro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.sis_agua_enfriamiento_reglas_de_oro, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_atrasReglasOro.setOnClickListener(v ->    Navigation.findNavController(v).navigate(R.id.sis_agua_enfriamiento_menu));
    ...
    private  void validar(){
        ...
        if(errors.size()>=1){
            ...
            Navigation.findNavController(requireView()).navigate(R.id.sis_agua_enfriamiento_equipos);
        }
    }
}