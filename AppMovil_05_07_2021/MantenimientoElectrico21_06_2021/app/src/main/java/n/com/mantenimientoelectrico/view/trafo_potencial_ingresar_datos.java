...
public class trafo_potencial_ingresar_datos extends Fragment implements SpinnersActions {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.trafo_potencial_ingresar_datos, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_atras.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.equipo_sobre_tension_equipos));
        ...
        simpleResponseModel.getSimpleResponseObserve().observe(getViewLifecycleOwner(), response -> {
            if ( response != null){
               ...
               navigate(R.id.trafo_potencial_act_1);
            }else
