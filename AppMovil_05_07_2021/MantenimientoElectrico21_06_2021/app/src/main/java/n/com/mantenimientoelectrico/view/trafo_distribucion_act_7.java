...
public class trafo_distribucion_act_7 extends Fragment implements EquipoPruebaListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.trafo_distribucion_act_7, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_guardar_detalleactividad=view.findViewById(R.id.btn_validar_act6);
        ...
        edit_valorPrueba=view.findViewById(R.id.valor_ResisElectrica);
        ...
        btn_atras1.setOnClickListener(v-> Navigation.findNavController(v).navigate(R.id.trafo_distribucion_act_6));
        ...
        actividadModel.getActividadObser().observe(getViewLifecycleOwner(), actividad -> {
            if ( actividad == null )
                ...
                Navigation.findNavController(requireView()).navigate(R.id.trafo_distribucion_act_8);
            }
        });
    }
    ...
    private void verificarDetalleActividad() {
        ...
        if(valorprueba.isEmpty() || nombre.isEmpty()){
            ...
            if(!isSave) {
                ...
                detalleActividad.setNombre("Resistencia eléctrica (Ω)");
