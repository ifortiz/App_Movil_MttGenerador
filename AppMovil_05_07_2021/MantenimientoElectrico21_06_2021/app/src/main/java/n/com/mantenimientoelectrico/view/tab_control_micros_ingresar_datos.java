...
public class tab_control_micros_ingresar_datos extends Fragment   implements SpinnersActions  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.tab_control_micros_ingresar_datos, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

        //Navigation.findNavController(v).navigate(R.id.tab_control_micros_act_1);
        ...
        simpleResponseModel.getSimpleResponseObserve().observe(getViewLifecycleOwner(), response -> {
            if ( response != null){
                ...
                navigate(R.id.tab_control_micros_act_1);
            }else
