...
public class trafo_potencia_ingresar_datos extends Fragment  implements SpinnersActions{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.trafo_potencia_ingresar_datos, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_atras.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.transformador_principal_equipos));
        ...
        simpleResponseModel.getSimpleResponseObserve().observe(getViewLifecycleOwner(), response -> {
            if ( response != null){
                Toast.makeText(getContext(), "Se ha registrado los datos corretamente", Toast.LENGTH_LONG).show();
                Navigation.findNavController(requireView()).navigate(R.id.trafo_potencia_act_1);
            }else
