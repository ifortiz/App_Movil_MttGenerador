...
public class sis_agua_enfriamiento_equipos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.sis_agua_enfriamiento_equipos, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btn_FinalizarSAE = view.findViewById(R.id.btn_FinalizarSAE);
        ...
        btn_FinalizarSAE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_AtrasEquipos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.sis_agua_enfriamiento_reglas_de_oro);
            }
        });
    }
}