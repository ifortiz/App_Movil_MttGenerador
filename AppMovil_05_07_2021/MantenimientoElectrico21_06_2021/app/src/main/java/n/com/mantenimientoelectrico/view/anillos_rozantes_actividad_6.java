...
public class anillos_rozantes_actividad_6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.anillos_rozantes_actividad_6, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txt_nombreActividad=view.findViewById(R.id.textDescricionActividad6);
        txt_observaciones=view.findViewById(R.id.textDeObservacionesActividad6);
        txt_numeroAct=view.findViewById(R.id.numeroDeActividad6);
        actividad=new Actividad();
        preferences=requireActivity().getSharedPreferences(getString(R.string.app_name),0);
        setupListenerRadiobuttons(rg_1,R.id.checkBoxNoAct6,edit_noRespuesta);

        btn_siguienteAct6.setOnClickListener(v -> verificarActividad());
        btn_atrasAct6.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.anillos_rozantes_actividad_5));
        ...
        actividadModel.getActividadObser().observe(getViewLifecycleOwner(), actividad -> {
            if ( actividad == null )
                ...
                Navigation.findNavController(requireView()).navigate(R.id.anillos_rozantes_actividad_7);
            }
        });
    }

    private void verificarActividad(){
    String cumplimiento = Validator.validarRadiobuttons(rg_1,R.id.checkBoxNoAct6,edit_noRespuesta,requireContext());
