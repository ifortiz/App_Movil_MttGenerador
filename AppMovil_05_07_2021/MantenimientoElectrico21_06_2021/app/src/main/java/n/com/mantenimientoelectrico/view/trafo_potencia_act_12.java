...
public class trafo_potencia_act_12 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.trafo_potencia_act_12, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_atras1.setOnClickListener(v ->   Navigation.findNavController(v).navigate(R.id.trafo_potencia_act_11));
        ...
        actividadModel.getActividadObser().observe(getViewLifecycleOwner(), actividad -> {
            if ( actividad != null ){
                ...
                Navigation.findNavController(requireView()).navigate(R.id.trafo_potencia_act_13);
            }
        });
    }
